...
export const About = () => {
    ...
    const proficiencies = [
        {
            icon: <IoLogoHtml5 className="html" />,
            text: "HTML"
        },
        {
